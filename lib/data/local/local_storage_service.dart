...
class LocalStorageService {
  ...
  Future<Set<String>> loadFavorites() async {
    ...
    try {
      ...
      AppLogger.warning('Failed to decode favorites, resetting', error: e, stackTrace: st);
      return {};
    }
  }
  ...
  Future<StoredCache?> loadJsonCache(String fileName) async {
    ...
    try {
      ...
      AppLogger.warning('Failed to read cache file "$fileName"', error: e, stackTrace: st);
      return null;
    }
  }
}
